...
public class ExceptionControllerAdvice {
   ...
   *
   * @param model                  an object which transfer data between view and controller.
  ...
  public String handleDateNotFoundException(Model model,
    ...
    dateNotFoundException.setErrorMessage("Please choose Date of Birth !");
   ...
   *
   * @param model                 an object which transfer data between view and controller.
   * @param newsNotFoundException an object of NewsNotFound class.
